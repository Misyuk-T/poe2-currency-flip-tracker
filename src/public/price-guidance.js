...
/**
 * Pick the single price used for user-facing decisions. Manual observations
 * override the delayed hourly midpoint; otherwise the latest hourly reference is
 * used honestly with its age/source attached.
 */
...
/**
 * Rebase the typical completed-hour low/high envelope onto a user-observed
 * current price. Absolute historical prices are deliberately ignored: history
 * contributes only relative low/reference and high/reference deviations.
 */
